...
<head>
    ...
    <style>
        body {
            background-image:url('<?php echo e(Voyager::image( Voyager::setting("admin.bg_image"), voyager_asset("images/bg3.jpg") )); ?>');
...
<?php /**PATH C:\xampp\htdocs\municipcom\admin\vendor\tcg\voyager\src/../resources/views/auth/master.blade.php ENDPATH**/ ?>